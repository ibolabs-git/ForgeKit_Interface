...
- Phase parser sada prihvata `PROJECT_PHASES_CONFIRMED` i `PROJECT_PHASES_SYNCED` tagove sa optional project atributom, a eksplicitna korisnicka potvrda moze potvrditi faze iz poslednjeg assistant predloga.
